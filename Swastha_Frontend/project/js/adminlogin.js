async function user_login() {
    ...
    if (email_input != '' && password_input != '') {
        let response = await fetch(`http://localhost:8080/login?email=${email_input}&password=${password_input}`, {
            ...
            .then(data => {
                // window.location.href = 'http://127.0.0.1:5500/project/html/dum.ht ml', '_blank'
                console.log(data);
            })
            .catch(error => {
...
//     //     .then(data => {
//     //         alert("Form submitted successfully!")
//     //         window.location.href = 'http://127.0.0.1:5500/project/login.html'
//     //         console.log(data);
//     //     })
//     //     .catch(error => {
//     //         console.log("Error:", error);
    ...
    if (email != '' && password != '') {
        try {
            ...
            if (x.status === 302) {
                ...
                window.location.href = "http://127.0.0.1:5500/project/html/admin_main.html";
